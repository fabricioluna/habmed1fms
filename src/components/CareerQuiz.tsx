        ...
        <div className="bg-white rounded-[2.5rem] shadow-2xl overflow-hidden border border-gray-100">
          ...
          <div className="p-6 md:p-10 space-y-10">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-blue-50 p-8 rounded-3xl border border-blue-100 h-full flex flex-col justify-start">
                <h3 className="flex items-center gap-3 text-xs font-black uppercase text-blue-800 mb-4"><Target size={18} className="text-[#D4A017]"/> Conselho do Mentor</h3>
                <p className="text-sm text-blue-800 leading-relaxed font-medium">{data.advice}</p>
              </div>
            </div>
                ...
                {sorted.slice(1, 7).map(([spec, score], idx) => (
                  <div key={spec}>
                    ...
                    <div className="w-full bg-gray-200 h-1.5 rounded-full overflow-hidden">
                      <div className="bg-gray-400 h-full transition-all duration-1000" style={{width: `${Math.max(10, (score/(top[1] as number))*100)}%`}}></div>
                    </div>
                  </div>
                ))}
              </div>
