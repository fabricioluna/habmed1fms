  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f4f7f6] font-sans">
      ...
      <div className="flex-grow">
        {currentView === 'home' && <HomeView disciplines={SIMULATIONS} onNavigateToQuiz={() => setCurrentView('career-quiz')} onNavigateToCalculators={() => setCurrentView('calculators')} onSelectOption={(opt, id) => {setSelectedDisciplineId(id); setCurrentView(opt as ViewState);}} />}
